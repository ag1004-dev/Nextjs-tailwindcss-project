              ...
              <div className='w-full lg:w-6/12 px-4 ml-auto mr-auto text-center'>
                <div className='pr-12'>
                  <h1 className='text-white font-semibold text-5xl'>
                    Your story starts with Over 40 Web Club.
                  </h1>
            ...
            <div className='flex flex-wrap items-center mt-32'>
              <div className='w-full md:w-5/12 px-4 mr-auto ml-auto'>
                ...
                <h3 className='text-3xl mb-2 font-semibold leading-normal'>
                  Learning with Over 40 Web Club members is a pleasure
                </h3>
            ...
            <div className='flex flex-wrap'>
              <div className='w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4'>
                <div className='px-6'>
                  <img
                    alt='...'
                    src='/img/team-pitang.jpg'
                    className='shadow-lg rounded-full mx-auto max-w-120-px'
                  />
                  <div className='pt-6 text-center'>
                    <h5 className='text-xl font-bold'>Pitang</h5>
              ...
              <div className='w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4'>
                <div className='px-6'>
                  <img
                    alt='...'
                    src='/img/team-son.jpg'
                    className='shadow-lg rounded-full mx-auto max-w-120-px'
                  />
                  <div className='pt-6 text-center'>
                    <h5 className='text-xl font-bold'>そんほんす</h5>
                    <p className='mt-1 text-sm text-blueGray-400 uppercase font-semibold'>
              ...
              <div className='w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4'>
                <div className='px-6'>
                  <img
                    alt='...'
                    src='/img/team-n-kazu.jpg'
                    className='shadow-lg rounded-full mx-auto max-w-120-px'
                  />
                  <div className='pt-6 text-center'>
                    <h5 className='text-xl font-bold'>Kazu</h5>
                    <p className='mt-1 text-sm text-blueGray-400 uppercase font-semibold'>
                      UI/UX Designer
                    </p>
                    <div className='mt-6'>
              ...
              <div className='w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4'>
                <div className='px-6'>
                  <img
                    alt='...'
                    src='/img/team-yoko.jpg'
                    className='shadow-lg rounded-full mx-auto max-w-120-px'
                  />
                  <div className='pt-6 text-center'>
                    <h5 className='text-xl font-bold'>yoko</h5>
                    <p className='mt-1 text-sm text-blueGray-400 uppercase font-semibold'>
                      Founder and CEO
                    </p>
                    <div className='mt-6'>
