          ...
          <div className='w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4'>
            <div className='pt-32 sm:pt-0'>
              <h2 className='font-semibold text-4xl text-blueGray-600'>
                Over 40 Web Club✨ - A beautiful extension for Tailwind CSS.
              </h2>
              ...
              <div className='mt-12'>
                <a
                  href='https://github.com/over-40-web-club/'
                  target='_blank'
                ...
                <a
                  href='https://github.com/over-40-web-club/over40webclub-new'
        ...
        <div className='container mx-auto pb-64'>
          <div className='flex flex-wrap justify-center'>
            <div className='w-full md:w-5/12 px-12 md:px-4 ml-auto mr-auto md:mt-64'>
              ...
              <a
                href='https://github.com/over-40-web-club/notus-nextjs?ref=nnjs-index'
                target='_blank'
